...
def compute_loss_regression(smooth_l1_loss, Rs, Rt, y_reg_s, y_reg_t , m, bbox_inside_weights_s,bbox_inside_weights_t, bbox_outside_weights_s,bbox_outside_weights_t,ni=0.5):
