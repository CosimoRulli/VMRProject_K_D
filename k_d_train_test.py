...
if __name__ == '__main__':
    ...
    load_name = os.path.join(input_dir,
                             args.t_net + '_teacher_fast_rcnn_{}_{}_{}.pth'.format(args.t_checksession,
                                                                                   args.t_checkepoch,
                                                                                   args.t_checkpoint))
    ...
    if args.resume:
        load_name = os.path.join(output_dir,
                                 '{}_{}_student_net_{}_{}_{}.pth'.format(args.m, args.mu, args.s_checksession,
                                                                         args.s_checkepoch, args.s_checkpoint))
    ...
    for epoch in range(args.start_epoch, args.max_epochs + 1):
        ...
        for step in range(iters_per_epoch):
            ...
            loss_rpn_reg, loss_rpn_reg_soft = compute_loss_regression(rpn_loss_box_s, R_s, R_t, y_reg_s, y_reg_t, m=m,
                                                                      ...
                                                                      bbox_outside_weights_t=ow_t, ni=ni)
        ...
        if (epoch != 0 and epoch % 3 == 0):
            save_name = os.path.join(output_dir,
                                     '{}_{}_student_net_{}_{}_{}.pth'.format(args.m, args.mu, args.session, epoch,
                                                                             step))
            save_checkpoint({
                'session': args.session,
                'epoch': epoch + 1,
